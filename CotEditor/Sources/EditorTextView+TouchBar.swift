    ...
    override func touchBar(_ touchBar: NSTouchBar, makeItemForIdentifier identifier: NSTouchBarItem.Identifier) -> NSTouchBarItem? {
        ...
        switch identifier {
            case .shift:
                ...
                let leftImage = NSImage(systemSymbolName: "increase.indent", accessibilityDescription: "Shift Left".localized)!
                let rightImage = NSImage(systemSymbolName: "decrease.indent", accessibilityDescription: "Shift Right".localized)!
            ...
            case .comment:
                ...
                item.view = NSButton(image: NSImage(named: "text.commentout") ?? NSImage(systemSymbolName: "note.text", accessibilityDescription: "Comment out note")!, target: self, action: #selector(toggleComment))
                return item
